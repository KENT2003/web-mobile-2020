    ...
    <div id="footer">
        ...
        <form v-on:submit.prevent="onFormSubmit">
            ...
            <div id="btn-row">
                ...
                <div id="submit-row">
                <button class="white-btn" type="button" v-on:click="toggleSharePage">SHARE</button>
    ...
    methods: {
        useOtherMethod(){
            ...
            for(i in this.imgs){//將base64轉為file
                files.push(dataURLtoFile(this.imgs[i],'photo'+i));
            }
        ...
        onChange(e){
            ...
            if(navigator.geolocation){
                navigator.geolocation.getCurrentPosition((position)=>{//獲得gps地址
                    ...
                    marker.addTo(map);
                    $.ajax({//調用api
                        url: 'https://kinoras.com/development/api/geocoding/?key=28423118&long='+this.long+'&lati='+this.lat+'&lang=pt',
                        error: () =>{
                            console.log('error')
                        },
                        success: (data)=>{
